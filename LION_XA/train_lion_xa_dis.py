...
def train(cfg, output_dir='', run_name=''):
    ...
    for iteration in range(start_iteration, max_iteration):
        ...
        preds_2d_src_feats = preds_2d['feats_2d']
        preds_2d_src_logit = preds_2d['point_seg_logit']
        preds_3d_src       = preds_3d['seg_logit']
        ...
        # Discriminator 1 gets 2d source pred as input and source label
        d_source_2d_pred = model_s3d_t2d(F.softmax(preds_2d_src_logit.detach(), dim=1))
        ...
        # Discriminator 2 gets 3d source pred as input and source label
        d_source_3d_pred = model_s2d_t3d(F.softmax(preds_3d_src.detach(), dim=1))
        ...
        # Discriminator 3 gets 2d source features as input and source label
        d_source_2d_feat = model_s2d_t2d(preds_2d_src_feats.detach())
